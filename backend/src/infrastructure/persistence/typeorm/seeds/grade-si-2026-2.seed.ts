...
const DISCIPLINAS: {
    ...
    { codigo: 'ED', nome: 'Estrutura de Dados', cargaHoraria: 80, professorSiape: '10000001' },
    { codigo: 'SO', nome: 'Sistemas Operacionais', cargaHoraria: 80, professorSiape: '10000002' },
    { codigo: 'CPW1', nome: 'Construção de Páginas Web I', cargaHoraria: 66, professorSiape: '10000002' },
    { codigo: 'BD1', nome: 'Banco de Dados I', cargaHoraria: 66, professorSiape: '10000004' },
    { codigo: 'LP', nome: 'Linguagens de Programação', cargaHoraria: 66, professorSiape: '10000003' },
    { codigo: 'ES1', nome: 'Engenharia de Software I', cargaHoraria: 40, professorSiape: '10000005' },
];

const PROFESSORES: { siape: string; nome: string }[] = [
    { siape: '10000001', nome: 'Jonas Pontes' },
    { siape: '10000002', nome: 'Darueck Campos' },
    { siape: '10000003', nome: 'Alvaro Rios' },
    { siape: '10000004', nome: 'Mauricio Cunha' },
    { siape: '10000005', nome: 'Flavio Farias' },
];
...
const GRADE: BlocoGrade[] = [
    // Segunda
    { disciplina: 'ED', professor: '10000001', sala: 'LAB 1', dia: 1, ordens: [1, 2, 3] },
    { disciplina: 'SO', professor: '10000002', sala: 'LAB 1', dia: 1, ordens: [4, 5] },
    // Terça
    { disciplina: 'CPW1', professor: '10000002', sala: 'LAB 1', dia: 2, ordens: [1, 2] },
    { disciplina: 'BD1', professor: '10000004', sala: 'LAB 2', dia: 2, ordens: [3, 4] },
    // Quarta
    { disciplina: 'SO', professor: '10000002', sala: 'LAB 1', dia: 3, ordens: [1, 2] },
    { disciplina: 'ED', professor: '10000001', sala: 'LAB 1', dia: 3, ordens: [3, 4] },
    // Quinta
    { disciplina: 'LP', professor: '10000003', sala: 'LAB 2', dia: 4, ordens: [1, 2, 3] },
    { disciplina: 'CPW1', professor: '10000002', sala: 'LAB 1', dia: 4, ordens: [4] },
    // Sexta
    { disciplina: 'BD1', professor: '10000004', sala: 'LAB 2', dia: 5, ordens: [1, 2] },
    { disciplina: 'ES1', professor: '10000005', sala: 'LAB 1', dia: 5, ordens: [3] },
    { disciplina: 'ES1', professor: '10000005', sala: 'LAB 5', dia: 5, ordens: [4] },
];
    ...
    await dataSource.transaction(async (manager) => {
        ...
        for (const p of PROFESSORES) {
            const prof = await getOrCreate(
                ...
                ProfessorEntity,
                { siape: p.siape },
                { nome: p.nome, siape: p.siape, ativo: true },
            );
        ...
        for (const d of DISCIPLINAS) {
            ...
            await getOrCreate(
                ...
                { curso: { id: curso.id }, disciplina: { id: disc.id }, periodo: 2 } as never,
        ...
        await alocacaoRepo.delete({ periodoLetivo: { id: periodo.id } } as never);
