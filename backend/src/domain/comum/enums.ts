/**
 * Vocabulário ubíquo transversal. Mora no domínio (TypeScript puro); a
 * persistência re-exporta para uso nas colunas `@Column({ type: 'enum' })`,
 * mantendo uma única fonte da verdade sem o domínio depender de
 * `infrastructure`.
 */
